...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows == 1) {
        $stmt->bind_result($id, $email, $password_hash, $role);
        $stmt->fetch();
        ...
        if (password_verify($password, $password_hash)) {
            ...
            header("Location: hubhome.php"); // Redirect after successful login
            exit;
        } else {
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Secure Research Collaboration Hub</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Pages</li>
          <li class="breadcrumb-item active">Secure Research Collaboration Hub</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="card shadow">
    <div class="card-body">
      <h3 class="card-title text-center mb-4">Welcome to Secure Research Collaboration Hub</h3>
