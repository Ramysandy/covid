...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">HUB Home</h5>
    
    <p>
      <?php
        echo "Hi " . htmlspecialchars($_SESSION['email']) . ", welcome to the Secure Research Collaboration Hub.";
      ?>
    </p>

    <div style="margin-top: 20px;">
      <a href="hform.php" class="btn btn-primary mb-2">Fill Discussion</a>
      <a href="hresult.php" class="btn btn-success mb-2">View Latest Entries</a>
