...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <div class="card">
        <div class="card-body">
            <h5 class="card-title">Submit Research Entry</h5>
            <p>Please fill out the form to submit your research entry.</p>
            <form action="hform.php" method="POST">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    require_once 'config.php'; // Assuming $conn is your database connection
    ...
    $user_id = $_SESSION['user_id']; // Using the logged-in user's ID
    
    // Prepare SQL statement to insert data
    $stmt = $conn->prepare("INSERT INTO research_entries (user_id, title, description, region, date_of_observation) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("issss", $user_id, $title, $description, $region, $date_of_observation);
    
    // Execute the query
    if ($stmt->execute()) {
        echo "<div class='alert alert-success mt-3'>Entry successfully submitted!</div>";
    } else {
        echo "<div class='alert alert-danger mt-3'>Error submitting entry. Please try again.</div>";
    }
