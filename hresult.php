...
if ($filter === 'your') {
    $stmt = $conn->prepare("SELECT * FROM research_entries WHERE user_id = ?");
    $stmt->bind_param("i", $user_id);
} else {
    $stmt = $conn->prepare("SELECT * FROM research_entries");
}
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card">
  <div class="card-body">
    <h5 class="card-title">Research Entries</h5>
    <form method="POST" style="margin-bottom: 15px;">
      <button type="submit" name="filter" value="your" class="btn btn-primary">Your Entries</button>
      <button type="submit" name="filter" value="all" class="btn btn-secondary">All Entries</button>
    </form>
      ...
      <tbody>
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td><?= htmlspecialchars($row['date_of_observation']) ?></td>
