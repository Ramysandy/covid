<?php
session_start();
require_once 'config.php'; // DB connection assumed as $conn
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkStmt->num_rows > 0) {
        ...
        $insertStmt = $conn->prepare("INSERT INTO users (email, password_hash, role, affiliation) VALUES (?, ?, ?, ?)");
        $insertStmt->bind_param("ssss", $email, $password_hash, $role, $affiliation);
...
<body>
  ...
  <div class="card shadow">
    <div class="card-body">
      <h3 class="card-title text-center mb-4">Register for Secure Research Collaboration Hub</h3>
      ...
      <form method="POST" action="register.php">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="affiliation" name="affiliation" required placeholder="Institution / Organization">
        </div>
